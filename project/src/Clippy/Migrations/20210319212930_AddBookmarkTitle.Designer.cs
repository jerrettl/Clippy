...
namespace Clippy.Migrations
{
    ...
    [Migration("20210319212930_AddBookmarkTitle")]
    partial class AddBookmarkTitle
    {
            ...
            modelBuilder.Entity("Clippy.Entities.Bookmark", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 3, 19, 21, 29, 29, 660, DateTimeKind.Utc).AddTicks(7342),
                            ResourceId = 2,
                            UserId = 1
                        },
                        new
            ...
            modelBuilder.Entity("Clippy.Entities.Resource", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 3, 19, 21, 29, 29, 657, DateTimeKind.Utc).AddTicks(7778),
            ...
            modelBuilder.Entity("Clippy.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 3, 19, 21, 29, 29, 659, DateTimeKind.Utc).AddTicks(8764),
                            Name = "Clippy5 Team",
                            Username = "Clippy5"
                        });
                });
