...
namespace Clippy.Migrations
{
    ...
    [Migration("20210309162515_AddTags")]
            ...
            modelBuilder.Entity("Clippy.Entities.Bookmark", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 3, 9, 16, 25, 14, 918, DateTimeKind.Utc).AddTicks(2850),
                            ResourceId = 2,
                            UserId = 1
                        },
                        new
            ...
            modelBuilder.Entity("Clippy.Entities.Resource", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 3, 9, 16, 25, 14, 916, DateTimeKind.Utc).AddTicks(670),
            ...
            modelBuilder.Entity("Clippy.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 3, 9, 16, 25, 14, 917, DateTimeKind.Utc).AddTicks(6040),
                            Name = "Clippy5 Team",
                            Username = "Clippy5"
                        });
                });
