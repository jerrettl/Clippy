...
namespace Clippy.Migrations
{
    ...
    [Migration("20210306094757_AddGithubId")]
            ...
            modelBuilder.Entity("Clippy.Entities.Bookmark", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 3, 6, 9, 47, 57, 432, DateTimeKind.Utc).AddTicks(1313),
                            ResourceId = 2,
                            UserId = 1
                        },
                        new
            ...
            modelBuilder.Entity("Clippy.Entities.Resource", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 3, 6, 9, 47, 57, 430, DateTimeKind.Utc).AddTicks(2088),
            ...
            modelBuilder.Entity("Clippy.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 3, 6, 9, 47, 57, 431, DateTimeKind.Utc).AddTicks(5833),
                            Name = "Clippy5 Team",
                            Username = "Clippy5"
                        });
                });
